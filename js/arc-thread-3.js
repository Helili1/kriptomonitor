  ...
  posts: [
    {
      ...
      date: '3 часа назад',
      text: 'Сравниваем популярные биржи, комиссии, безопасность и удобство...'
    },
    {
      author: 'CryptoFan',
      avatar: '../assets/img/avatar_profile.png',
      date: '2 часа назад',
      text: 'Я пользуюсь Binance и Bybit, у них хорошие комиссии.'
    },
    {
      author: 'JustUser',
      avatar: '../assets/img/avatar_profile.png',
      date: '1 час назад',
      text: 'А кто-нибудь пробовал KuCoin? Как там с выводом?'
    }
  ]
};
...
function renderSidebar(posts) {
  document.getElementById('sidebarInfo').innerHTML = `
    ...
    <li><i class="far fa-eye"></i> Просмотров: <b>120</b></li>
